...
const LazyDetailFilmSpecie = lazy(() =>
  import("../pages/DetailFilmSpecie.jsx")
);
const LazyDetailFilmVehicle = lazy(() =>
  import("../pages/DetailFilmVehicle.jsx")
);
const LazyDetailFilmPlanet = lazy(() =>
  import("../pages/DetailFilmPlanet.jsx")
);
